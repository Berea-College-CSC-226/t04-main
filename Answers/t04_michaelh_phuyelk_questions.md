...
```        
    The difference is that our branch has the code changes
```

2.b. Do you see other groups’ branches in the repo as well? Is your code in their branch? Why or why not?

```        
    I see their branches but out code is not in their branch because we do not have an approved pull request
```
...
```
    No, because out pull request was not accepted
```
