...
|-----------------|--------|-----------|--------|
| Driver          | Mensah | Mach      |        |
| Navigator       | Mach   | Mensah    |        |
| Quality Control | Both   | Both      |        |
...
```
    Reading code a little bit, but more work still needed to understand the code flow and intuition. 
    It was slow but the direction seems right. 
    Creating functions is now much better than before, but we still need to lock in to be much better
```

1.b. Briefly describe any logic changes you made in your code, and why you made them.

```
    We changed the return type to a boolean.
```

1.c. Did you find it challenging following the logic of another group’s code? Why or why not?

```
    Yes sure, a code written by another person had different syntaxical and functions
```
