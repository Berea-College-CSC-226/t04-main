...
```
    **Having less syntax errors and are remembering what the code is and how it works**
```

1.b. Briefly describe any logic changes you made in your code, and why you made them.

```
    **We defined the isdead variable as a function to make it easier to look at and use**
```

1.c. Did you find it challenging following the logic of another group’s code? Why or why not?

```
    ** No it was pretty good we just added stuff we learned that we didnt know then**
```

1.d. Briefly describe two or more of the PEP8 warnings you fixed. Does the resulting code look better or worse? Why?

```
    ** Direction wasnt defined and we defined it. the code looks better and actually works**
```
...
```        
    **The files that we created arent there and the changes we made arent in main either**
```

2.b. Do you see other groups’ branches in the repo as well? Is your code in their branch? Why or why not?

```        
    **Yeah we see them in remote.No our code is not in there. because it hasnt been merged into main yet and they havent updated their project.**
```
...
```
    **Yes our code has been merged into main**
```
...
```
    **There have been a couple of more people who added code**
```
