...
```        
    Since t01 we have learned many new functions and code that can help us improve as individuals and learn how to troubleshoot the code we are given and create ourselves.
```
...
```
    We tried to make some changes with how the story was written, and what fruits created what changes in the story to make it more clear and run effectivly.
```
...
```
    it was not to challenging, we could use what we knew about storys code to make sense of what other people has coded into their programs.
```
