...
```
    Magnus: does not have to look back at previous assignments for clues or hints, gotten better at reading an 
    anticipating code 
```
...
```
    we did not make any logic changes
```

1.c. Did you find it challenging following the logic of another group’s code? Why or why not?

```
    no, we do not find it challenging
```

1.d. Briefly describe two or more of the PEP8 warnings you fixed. Does the resulting code look better or worse? Why?

```
    the name variable was not used, we added in code that used the name variable. 
```
...
```        
    the code we edited is different 
```
