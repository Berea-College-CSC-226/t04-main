...
```        
    We have learned how to utilize functions, as well as structuring to make code easier to read. As well as learning the Main function and how we can use it. 
```
